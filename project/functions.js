var functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a = 
{
	...
	*/
	...
	return [
		...
		[12, "毒攻击", "进入第5回合时主角会中毒，每一步损失生命" + core.values.poisonDamage + "点", "#99ee88"],
		[13, "衰弱攻击", function (enemy) { return "进入第5回合时主角会进入衰弱状态，攻防暂时下降" + (enemy.damage || 1) + "点"; }, "#f0bbcc"],
		...
		[53, "狂暴之拳", "随机攻击次数（1-3，复刻版固定为1），且主角被击中后会增加疲劳（每次攻击疲劳+1）", "#bbeef0"],
		...
		[61, "冰秘术", "全体魔法攻击，进入第5回合时主角会中毒", "#80eed6"],
		[62, "风秘术", "全体魔法攻击，攻击会恢复自身的疲倦", "#80eed6"],
		[63, "火秘术", "全体魔法攻击", "#80eed6"],
		[64, "秘术·死寂光环", "全体魔法攻击；战斗中主角不会增加气息（实际仍会增加）", "#80eed6"],
		...
		[81, "破甲刃", "攻击会减低主角防御力，40%几率降低12点（复刻版为3k+1次攻击时触发）", "#b30000"],
		[82, "猛毒", "进入第5回合时主角会中毒；如果主角已在毒状态时，它每次攻击有60%几率使攻击力与防御力提升10点（复刻版为奇数次攻击时触发）", "#99ee88"],
		[83, "狂战士之拳", "随机攻击次数（2-5，复刻版为2,3,2,3,...），且主角被击中后会增加疲劳（每次攻击疲劳+4）", "#bbeef0"],
		[84, "狂战士之斧", "攻击附带额外固定100伤害", "#bbb0ff"],
		[85, "硬化+", "如主角攻击力比它基本防御力高时，它的攻击力及防御力会变成主角的攻击力", "#c0b088"],
		[86, "死气", "它被攻击中时，主角会感到很疲劳（主角每击中它一次疲劳+10）", "#a349a4"],
		[87, "麻痹触手", "一回合六次攻击；进入第5回合时主角会进入衰弱状态", "#f0bbcc"],
		[88, "鬼吹灯", "攻击会扣除主角的气息40点（不足则清零），然后自身气息增加40点", "#ff6666"],
		[89, "压制", "攻击会减低主角战斗力，60%几率降低20攻击，5防御（复刻版为奇数次攻击时触发）", "#b30000"],
