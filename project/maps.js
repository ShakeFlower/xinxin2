var maps_90f36752_8815_4be8_b32b_d7fad1d0542e = 
{
	...
	"195": {"cls":"npcs","id":"dlb"},
	"196": {"cls":"npcs","id":"drb"},
	"198": {"cls":"npcs","id":"ook","event":[{"type":"if","condition":"(!item:A9)","true":["\t[勇者,hero]哇！怎么会有本奇怪的书本在这儿…","\t[脸书,ook]奇什么怪啊！你这个人真没礼貌！","\t[勇者,hero]怎么…！还会说话的！真够奇怪！","\t[脸书,ook]什么第一次见面就奇怪来奇怪去的！首先，我是有名字的，不是什么奇怪的书！","\t[脸书,ook]只要看到我一张帅脸在书上，就知道我叫“脸书”了吧！哈哈","\t[勇者,hero]哈哈…（真的超奇怪啊…）","\t[脸书,ook]不说这么多开场话了…我能够将你目前游戏状况分享至Facebook——\n因为你正在玩h5复刻版，所以其实是分享到h5mota.com。\n你可以在地图上发送在线留言，或者求援来给你回血（结算分数会变成1分）","\t[脸书,ook]很厉害吧！往后冒险中还有很多我的同伴，我们每一个分享的讯息都不一样啊！\n要积极找我们对话！明白没？","\t[勇者,hero]明白了…","\t[脸书,ook]你可以对外求援然后\\d\r[red]恢复1000体力\r\\d，但是结算分数会变成1分",{"type":"setValue","name":"item:A9","value":"1"}],"false":[{"type":"insert","name":"脸书"}]}]},
