		...
		*/
		...
		function enemyAni(id, critical) {
			switch (id) {
				...
				case 'zombie':
				case 'poisonZombie':
					return critical ? 'g6-cri' : 'g6'; //兽人，毒丧尸攻击
				case 'grayPriest':
				...
				case 'E438':
				case 'octopus':
					return critical ? 'g8-cri' : 'g8'; //八爪鱼，四手史莱姆人，触手植物，巨大（魔界）八爪鱼，触手魔物攻击
				...
				case 'E337':
				case 'E414':
					return critical ? 'g33-cri' : 'g33'; //邪眼史莱姆，鬼邪石攻击
				case 'skeletonKing':
